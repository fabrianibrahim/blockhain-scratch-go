...
/**
 * Notes: Using pointers (*) allows us to store references to the original objects.
 * This means that modifications to the fields within the ProofOfWork struct would
 * directly affect the original objects, which can be beneficial for memory management
 * and avoiding unnecessary copying of data, especially for large objects like blocks
 * and big integers.
 */
